// DitherShader from Aceternity UI (https://ui.aceternity.com/components/dither-shader),
// adapted for Vite: no "use client", local cn helper. Canvas-based ordered dithering.
