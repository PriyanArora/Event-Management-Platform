// NoiseBackground from Aceternity UI (https://ui.aceternity.com/components/noise-background),
// adapted for Vite: no "use client", local cn, dark-only surface tokens,
// noise texture self-hosted at /noise.webp.
...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-[#1F1F23] p-2 backdrop-blur-sm",
        "shadow-[0px_1px_0px_0px_rgba(0,0,0,0.9)_inset,0px_1px_0px_0px_rgba(255,255,255,0.06)]",
        backdropBlur &&
