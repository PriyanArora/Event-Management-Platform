// MacbookScroll from Aceternity UI (https://ui.aceternity.com/components/macbook-scroll),
// adapted for Vite: no "use client", local cn, dark-only colors, qeue wordmark on the lid.
